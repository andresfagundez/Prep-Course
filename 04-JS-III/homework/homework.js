...
function promedioResultadosTest(resultadosTest) {
  ...
  for (let i=0; i<resultadosTest.length; i++) {
    ...
    promedio = Math.round(suma / resultadosTest.length);
  }
  return promedio;
}
...
function multiplicarArgumentos() {
  ...
  var productoDeMultiplicar = 1;

  for (let i=0; i < arguments.length; i++) {
    productoDeMultiplicar = productoDeMultiplicar * arguments[i]
  } return productoDeMultiplicar;
...
function cuentoElementos(arreglo){
  ...
  for (let i=0; i < arreglo.length; i++){
    if(arreglo[i] > 18) cantidadDeElementos = cantidadDeElementos + 1;
  }
...
function diaDeLaSemana(numeroDeDia) {
  ...
  // 1= Dom. 2= Lun. 3= Mar. 4= Mier. 5= Juev. 6= Vier. 7= Sab.
} 
...
function todosIguales(arreglo) {
  ...
  for (let i=0; i<arreglo.length; i++) {
    if (arreglo[i] !== todosIguales) return false;
  }
  return true;
